...
const testimonials = [
  {
    quote: "Recently moved here but with the summer heat and weather changes the bugs have making an appearance a little too often for me.",
    name: 'Lynn Q.',
  ...
  {
    quote: "Great pest control company so far!!!!! Customer service is awesome too!!! Latiera is the best! Thanks again! Highly Recommend!",
    name: 'John Choi',
    location: 'Los Angeles, CA',
    initials: 'JC',
    rating: 5,
  ...
  {
    quote: "Had my fathers house in LA sprayed for bugs. Amen Pest was referred by a good friend. Glad I called, they were on time and the tech did a great job.",
    name: 'Jim Matthews',
    location: 'Los Angeles, CA',
    initials: 'JM',
    rating: 5,
  ...
  {
    quote: "I recommend Amen Pest Control. They are punctual, informative and quick to answers your questions. I've also seen an immediate decline with bugs and such since there visit. I plan on having them back to keep it that way.",
    name: 'Francine T.',
    location: 'Los Angeles, CA',
    initials: 'FT',
    rating: 5,
  ...
  {
    quote: "My first time having to call for pest control service and I was recommended to Amen pest control by a friend. They did an amazing job and took care of my probably quickly. Great customer service, will recommend to family and friends.",
    name: 'Andrea R.',
    location: 'Los Angeles, CA',
    initials: 'AR',
    rating: 5,
